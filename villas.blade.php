    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="page-subtitle">Yönetici hesap bilgilerinizi ve güvenlik ayarlarınızı yönetin</p>
            </div>
            ...
            <div class="profile-info-card">
                <div class="profile-avatar-section">
                    ...
                    <div class="admin-badge">
                        <i class="fas fa-crown me-2"></i>Sistem Yöneticisi
                    </div>
                ...
                <div class="profile-stats">
                    ...
                    <div class="stat-item">
                        <div class="stat-number">{{ \App\Models\Villa::count() }}</div>
